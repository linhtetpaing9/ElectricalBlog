...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Job Create</h1>
        <form action="{{route('jobs.store')}}" id="form-data" method="POST">
        @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="1.5 lakhs - 2.5 lakhs" name="salary">
        </div>
        <div id="app">
